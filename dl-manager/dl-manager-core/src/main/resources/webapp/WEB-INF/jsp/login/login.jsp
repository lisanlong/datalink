        ...
        <div class="row">
            <div class="col-sm-10 col-sm-offset-1">
                <div class="login-container">
                    <div class="center" style="width: 500px;padding-top:30%;">
                        <h1>
                            <%--<i class="ace-icon fa fa-automobile light-blue"></i>--%>
                            <span class="red"></span>
                            <span class="white" id="id-text2" >百思数据共享交换平台系统</span>
                        </h1>
                    </div>
                    ...
                    <div class="center">
                        <h4 class="light-blue" id="id-company-text" style="width: 500px">&copy; 北京百思汇信科技有限公司</h4>
                    </div>
                </div>
            </div>
            <!-- /.col -->
